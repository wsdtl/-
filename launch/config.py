...
def load_config() -> Config:
    ...
    # 项目基础配置。
    project_id = env.get("PROJECT_ID", "xiaonan_xiuxian").strip()
    project_name = env.get("PROJECT_NAME", "晓楠修仙").strip()
    ...
    log_dir = env.get_path("LOG_DIR", BASE_DIR / "log")
